      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            console.error("Failed to parse metadata for contract " + address + " with uri " + uri);
            console.error(_context.t0); // return error contract metadata

            return _context.abrupt("return", {
              uri: "",
              name: "Failed to module load metadata",
              description: "Something went wrong when loading this module's metadata, you can check your console logs for more information."
            });
          ...
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return Promise.all(addresses.map(function (address) {
                return getContractMetadata(_this2.providerOrSigner, address, _this2.sdk.getStorage(), resolveGateway)["catch"](function (err) {
                  console.error("failed to load metadata for contract: " + address, err);
                  return undefined;
                });
              }));
